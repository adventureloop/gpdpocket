 ...
 *
 * Disassembly of dsdt.dat, Fri May  4 21:59:37 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001DB3C (121660)
 *     Revision         0x02
 *     Checksum         0x92
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    OperationRegion (GNVS, SystemMemory, 0x7B6A5000, 0x0367)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (I2C3)
        {
            ...
            Device (NFC2)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    Name (SBUF, ResourceTemplate ()
                    {
                        I2cSerialBusV2 (0x005E, ControllerInitiated, 0x00061A80,
                            AddressingMode7Bit, "\\_SB.PCI0.I2C3",
                            0x00, ResourceConsumer, , Exclusive,
                            )
                        GpioIo (Exclusive, PullDefault, 0x0000, 0x0000, IoRestrictionOutputOnly,
        ...
        Device (I2C6)
        {
            ...
            Device (TCSE)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (WBUF) /* \_SB_.PCI0.I2C6.TCSE._CRS.WBUF */
                }
                ...
                OperationRegion (IADR, SystemMemory, 0xFED9D810, 0x08)
                ...
                OperationRegion (SADR, SystemMemory, 0xFED98300, 0x04)
                Field (SADR, DWordAcc, NoLock, Preserve)
                {
                    ISTS,   32
                }

                OperationRegion (MADR, SystemMemory, 0xFED98380, 0x04)
                ...
                Method (_REG, 2, NotSerialized)  // _REG: Region Availability
                {
                    If ((Arg0 == Zero))
                    {
                        If ((Arg1 == One))
                        {
                            If ((CFB1 == Zero))
                            {
                                Local0 = CNF1 /* \_SB_.PCI0.I2C6.TCSE.CNF1 */
                                CFB1 = Local0
                            }
                        }
                    }
                ...
                {
                    Acquire (MTEX, 0x0064)
                    Local0 = CNF0 /* \_SB_.PCI0.I2C6.TCSE.CNF0 */
                    Local0 &= 0xFFFFF8FF
                    Local0 |= 0x0200
                    CNF0 = Local0
                    If ((CFB1 != Zero))
                    {
                        CNF1 = CFB1 /* \_SB_.PCI0.I2C6.TCSE.CFB1 */
                    }

                    Local0 = CNF0 /* \_SB_.PCI0.I2C6.TCSE.CNF0 */
                    Local1 = ((Local0 >> 0x1C) & 0x0F)
                    Local0 = IMSK /* \_SB_.PCI0.I2C6.TCSE.IMSK */
                    Local0 |= (One << Local1)
                    IMSK = Local0
                    Release (MTEX)
                }
                ...
                Method (INTO, 1, Serialized)
                {
                    ...
                    If ((CFB1 == Zero))
                    {
                        CFB1 = CNF1 /* \_SB_.PCI0.I2C6.TCSE.CNF1 */
                    }
                    ...
                    Local0 &= ~(One << Local1)
                    IMSK = Local0
                    Local0 = ISTS /* \_SB_.PCI0.I2C6.TCSE.ISTS */
                    Local0 |= (One << Local1)
                    ISTS = Local0
                    Local0 = CNF0 /* \_SB_.PCI0.I2C6.TCSE.CNF0 */
                    Local0 &= 0xFFFFF8FF
        ...
        Scope (URT1)
        {
            Device (BTH7)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If ((OSID == One))
                    {
                        Return (WBUF) /* \_SB_.PCI0.URT1.BTH7._CRS.WBUF */
                    }

                    Return (ABUF) /* \_SB_.PCI0.URT1.BTH7._CRS.ABUF */
                }
            }

            Device (BTH3)
            {
                Name (_HID, "BCM2E7E")  // _HID: Hardware ID
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    Return (0x0F)
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (UBUF) /* \_SB_.PCI0.URT1.BTH3._CRS.UBUF */
                }
            }
        }
                            ...
                            If ((_T_0 == 0x03))
                            {
                                While (One)
                                {
                                    ...
                                    ElseIf ((_T_1 == 0x04))
                                    {
                                        Return (Buffer (0x44)
                                        {
                                            /* 0000 */  0x08, 0x00, 0x00, 0xCE, 0x40, 0x00, 0x01, 0x00,  /* ....@... */
                                            ...
                                            /* 0020 */  0x00, 0x00, 0x0D, 0x00, 0x14, 0x00, 0x01, 0x00,  /* ........ */
                                            /* 0028 */  0x00, 0x20, 0x1E, 0x00, 0x4B, 0x00, 0x01, 0x00,  /* . ..K... */
                                            /* 0030 */  0x01, 0x00, 0x00, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* ........ */
                                            /* 0038 */  0x88, 0x88, 0x01, 0x00, 0x4D, 0x00, 0x01, 0x00,  /* ....M... */
                                    ...
                                    ElseIf ((_T_1 == 0x02))
                                    {
                                        ...
                                        {
                                            /* 0000 */  0x01, 0x30, 0x45, 0x56, 0x1E, 0x00, 0x01, 0x00,  /* .0EV.... */
                                            /* 0008 */  0xA4, 0x00, 0x5D, 0x06, 0x01, 0x00, 0xA5, 0x00,  /* ..]..... */
                                            /* 0010 */  0x00, 0x00, 0x01, 0x00, 0xEB, 0x00, 0x15, 0x01,  /* ........ */
                                            /* 0018 */  0x01, 0x00, 0xEC, 0x00, 0xC4, 0xFD, 0x01, 0x00,  /* ........ */
                                            /* 0020 */  0xED, 0x00, 0x29, 0x1F, 0x01, 0x00, 0xEE, 0x00,  /* ..)..... */
                                            /* 0028 */  0xDA, 0x92, 0x01, 0x00, 0xE7, 0x00, 0xBA, 0x1E,  /* ........ */
                                            /* 0030 */  0x01, 0x00, 0xE8, 0x00, 0x9D, 0xE1, 0x01, 0x00,  /* ........ */
                                            /* 0038 */  0xE9, 0x00, 0x51, 0x01, 0x01, 0x00, 0xEA, 0x00,  /* ..Q..... */
                                            /* 0040 */  0x8C, 0x93, 0x01, 0x00, 0xE5, 0x00, 0xB5, 0x01,  /* ........ */
                                            /* 0048 */  0x01, 0x00, 0xE6, 0x00, 0x82, 0xC8, 0x01, 0x00,  /* ........ */
                                            /* 0050 */  0xAE, 0x00, 0xEA, 0xC0, 0x01, 0x00, 0xAF, 0x00,  /* ........ */
                                            /* 0058 */  0x2C, 0x1F, 0x01, 0x00, 0xB0, 0x00, 0xEC, 0x0F,  /* ,....... */
                                            /* 0060 */  0x01, 0x00, 0xB4, 0x00, 0x04, 0xE9, 0x01, 0x00,  /* ........ */
                                            /* 0068 */  0xB5, 0x00, 0x10, 0x1C, 0x01, 0x00, 0xB6, 0x00,  /* ........ */
                                            /* 0070 */  0x00, 0x00, 0x01, 0x00, 0xBA, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0078 */  0x01, 0x00, 0xBB, 0x00, 0x10, 0x1C, 0x01, 0x00,  /* ........ */
                                            /* 0080 */  0xBC, 0x00, 0x00, 0x00, 0x01, 0x00, 0xC0, 0x00,  /* ........ */
                                            /* 0088 */  0x36, 0x04, 0x01, 0x00, 0xC1, 0x00, 0x00, 0x00,  /* 6....... */
                                            /* 0090 */  0x01, 0x00, 0xC4, 0x00, 0xB4, 0x1F, 0x01, 0x00,  /* ........ */
                                            /* 0098 */  0xC5, 0x00, 0x4B, 0x00, 0x01, 0x00, 0xC6, 0x00,  /* ..K..... */
                                            /* 00A0 */  0xB4, 0x1F, 0x01, 0x00, 0xCA, 0x00, 0xA9, 0x05,  /* ........ */
                                            /* 00A8 */  0x01, 0x00, 0xCC, 0x00, 0x00, 0x08, 0x00, 0x00,  /* ........ */
                                            /* 00B0 */  0xB1, 0x00, 0xC2, 0x30, 0x00, 0x00, 0xB0, 0x00,  /* ...0.... */
                                            /* 00B8 */  0x00, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* .`...... */
                                            ...
                                            /* 00F0 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1C, 0x00,  /* ........ */
                                            /* 00F8 */  0x01, 0x00, 0xA6, 0x00, 0x5D, 0x06, 0x01, 0x00,  /* ....]... */
                                            /* 0100 */  0xA7, 0x00, 0x00, 0x00, 0x01, 0x00, 0xF5, 0x00,  /* ........ */
                                            /* 0108 */  0x15, 0x01, 0x01, 0x00, 0xF6, 0x00, 0xC4, 0xFD,  /* ........ */
                                            /* 0110 */  0x01, 0x00, 0xF7, 0x00, 0x29, 0x1F, 0x01, 0x00,  /* ....)... */
                                            /* 0118 */  0xF8, 0x00, 0xDA, 0x92, 0x01, 0x00, 0xF1, 0x00,  /* ........ */
                                            /* 0120 */  0xBA, 0x1E, 0x01, 0x00, 0xF2, 0x00, 0x9D, 0xE1,  /* ........ */
                                            /* 0128 */  0x01, 0x00, 0xF3, 0x00, 0x51, 0x01, 0x01, 0x00,  /* ....Q... */
                                            /* 0130 */  0xF4, 0x00, 0x8C, 0x93, 0x01, 0x00, 0xEF, 0x00,  /* ........ */
                                            /* 0138 */  0xB5, 0x01, 0x01, 0x00, 0xF0, 0x00, 0x82, 0xC8,  /* ........ */
                                            /* 0140 */  0x01, 0x00, 0xB1, 0x00, 0xEA, 0xC0, 0x01, 0x00,  /* ........ */
                                            /* 0148 */  0xB2, 0x00, 0x2C, 0x1F, 0x01, 0x00, 0xB3, 0x00,  /* ..,..... */
                                            /* 0150 */  0xEC, 0x0F, 0x01, 0x00, 0xB7, 0x00, 0x04, 0xE9,  /* ........ */
                                            /* 0158 */  0x01, 0x00, 0xB8, 0x00, 0x10, 0x1C, 0x01, 0x00,  /* ........ */
                                            /* 0160 */  0xB9, 0x00, 0x00, 0x00, 0x01, 0x00, 0xBD, 0x00,  /* ........ */
                                            /* 0168 */  0x00, 0x00, 0x01, 0x00, 0xBE, 0x00, 0x10, 0x1C,  /* ........ */
                                            /* 0170 */  0x01, 0x00, 0xBF, 0x00, 0x00, 0x00, 0x01, 0x00,  /* ........ */
                                            /* 0178 */  0xC2, 0x00, 0x36, 0x04, 0x01, 0x00, 0xC3, 0x00,  /* ..6..... */
                                            /* 0180 */  0x00, 0x00, 0x01, 0x00, 0xC7, 0x00, 0xB4, 0x1F,  /* ........ */
                                            /* 0188 */  0x01, 0x00, 0xC8, 0x00, 0x4B, 0x00, 0x01, 0x00,  /* ....K... */
                                            /* 0190 */  0xC9, 0x00, 0xB4, 0x1F, 0x01, 0x00, 0xCB, 0x00,  /* ........ */
                                            /* 0198 */  0xA9, 0x05, 0x01, 0x00, 0xCD, 0x00, 0x00, 0x08,  /* ........ */
                                            ...
                                            /* 01E8 */  0x14, 0x00, 0x01, 0x00, 0xCE, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 01F0 */  0x01, 0x00, 0xCF, 0x00, 0x00, 0x00, 0x01, 0x00,  /* ........ */
                                            /* 01F8 */  0xD0, 0x00, 0x00, 0x00, 0x01, 0x00, 0xD1, 0x00,  /* ........ */
                                            /* 0200 */  0x00, 0x00, 0x01, 0x00, 0xD2, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0208 */  0x01, 0x00, 0xD3, 0x00, 0x00, 0x00, 0x01, 0x00,  /* ........ */
                                            /* 0210 */  0xD4, 0x00, 0x00, 0x00, 0x01, 0x00, 0xD5, 0x00,  /* ........ */
                                            /* 0218 */  0x00, 0x00, 0x01, 0x00, 0xD6, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0220 */  0x01, 0x00, 0xD7, 0x00, 0x00, 0x00, 0x01, 0x00,  /* ........ */
                                            /* 0228 */  0xD8, 0x00, 0x00, 0x00, 0x01, 0x00, 0xD9, 0x00,  /* ........ */
                                            /* 0230 */  0x00, 0x00, 0x01, 0x00, 0xDA, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0238 */  0x01, 0x00, 0xDB, 0x00, 0x00, 0x00, 0x01, 0x00,  /* ........ */
                                            /* 0240 */  0xDC, 0x00, 0x00, 0x00, 0x01, 0x00, 0xDD, 0x00,  /* ........ */
                                            /* 0248 */  0x00, 0x00, 0x01, 0x00, 0xE1, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0250 */  0x01, 0x00, 0xE2, 0x00, 0x00, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0258 */  0xAF, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAE, 0x00,  /* ........ */
                                            /* 0260 */  0x00, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* .`...... */
                                            ...
                                            /* 02D8 */  0x00, 0x00, 0x14, 0x00, 0x01, 0x00, 0xCE, 0x00,  /* ........ */
                                            ...
                                            /* 0350 */  0xAE, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00, 0x00,  /* ...`.... */
                                            ...
                                            /* 03C8 */  0x00, 0x00, 0x00, 0x00                           /* .... */
                                        })
                                    }
                                    ElseIf ((_T_1 == 0x03))
                                    {
                                        Return (Buffer (0x0132)
                                        {
                                            /* 0000 */  0x00, 0x20, 0x45, 0x56, 0x15, 0x00, 0x00, 0x00,  /* . EV.... */
                                            /* 0008 */  0xB3, 0x00, 0x1F, 0x06, 0x00, 0x00, 0xB4, 0x00,  /* ........ */
                                            /* 0010 */  0x2C, 0x42, 0x00, 0x00, 0xB5, 0x00, 0x00, 0x1F,  /* ,B...... */
                                            /* 0018 */  0x00, 0x00, 0xB6, 0x00, 0x1F, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0020 */  0xB7, 0x00, 0x00, 0x40, 0x00, 0x00, 0xF0, 0x00,  /* ...@.... */
                                            /* 0028 */  0x1F, 0x06, 0x00, 0x00, 0xF1, 0x00, 0x2C, 0x02,  /* ......,. */
                                            /* 0030 */  0x00, 0x00, 0xF2, 0x00, 0x00, 0x1F, 0x00, 0x00,  /* ........ */
                                            /* 0038 */  0xF3, 0x00, 0x1F, 0x00, 0x00, 0x00, 0xF4, 0x00,  /* ........ */
                                            /* 0040 */  0x00, 0x40, 0x00, 0x00, 0xEA, 0x00, 0x20, 0x0F,  /* .@.... . */
                                            /* 0048 */  0x01, 0x00, 0x94, 0x00, 0x00, 0x87, 0x01, 0x00,  /* ........ */
                                            /* 0050 */  0x95, 0x00, 0xC2, 0x7D, 0x01, 0x00, 0x96, 0x00,  /* ...}.... */
                                            /* 0058 */  0x77, 0xA1, 0x01, 0x00, 0x97, 0x00, 0x83, 0x53,  /* w......S */
                                            /* 0060 */  0x01, 0x00, 0x98, 0x00, 0xC2, 0x7D, 0x01, 0x00,  /* .....}.. */
                                            /* 0068 */  0x99, 0x00, 0x77, 0xA1, 0x01, 0x00, 0x9A, 0x00,  /* ..w..... */
                                            /* 0070 */  0x83, 0x53, 0x01, 0x00, 0x9B, 0x00, 0x3E, 0x00,  /* .S....>. */
                                            /* 0078 */  0x01, 0x00, 0x9C, 0x00, 0xC1, 0x02, 0x01, 0x00,  /* ........ */
                                            /* 0080 */  0x9D, 0x00, 0x7D, 0xD3, 0x05, 0x00, 0x00, 0x00,  /* ..}..... */
                                            /* 0088 */  0x01, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,  /* ........ */
                                            /* 0090 */  0x02, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0098 */  0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 00A0 */  0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,  /* ........ */
                                            /* 00A8 */  0x05, 0x00, 0x00, 0x00, 0xFE, 0xFF, 0xFF, 0xFF,  /* ........ */
                                            /* 00B0 */  0xFF, 0xFF, 0xFF, 0xFF, 0x03, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 00B8 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 00C0 */  0x05, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 00C8 */  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 00D0 */  0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 00D8 */  0x05, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 00E0 */  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 00E8 */  0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 00F0 */  0x05, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 00F8 */  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0100 */  0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0108 */  0x05, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0110 */  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0118 */  0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0120 */  0x05, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0128 */  0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00,  /* ........ */
                                            /* 0130 */  0x01, 0x00                                       /* .. */
                                        })
                                    }
                                    Else
        ...
        Scope (I2C3)
        {
            ...
            Device (KXJ0)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.PCI0.I2C3.KXJ0._CRS.RBUF */
                }
        ...
        Scope (\_SB)
        {
            Device (LID0)
            {
                ...
                OperationRegion (NSHR, SystemMemory, 0xFED84C28, 0x04)
                Field (NSHR, DWordAcc, NoLock, Preserve)
                {
                    PVAL,   8, 
                    Offset (0x04)
                }
            ...
            {
                Name (_ADR, Zero)  // _ADR: Address
                Name (_HID, "FAN02501")  // _HID: Hardware ID
                Name (_CID, "FAN02501")  // _CID: Compatible ID
                Name (_UID, One)  // _UID: Unique ID
                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    Return (0x0F)
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.FAN0._CRS.SBUF */
                }
            }
        }
        ...
        Device (GPO1)
        {
            ...
            Method (SAEI, 0, NotSerialized)
            {
                ...
                If ((OSID == One))
                {
                    If ((BDID == One))
                    {
                        Return (CBUF) /* \_SB_.GPO1.SAEI.CBUF */
                    }
                    Else
                    {
                        Return (RBUF) /* \_SB_.GPO1.SAEI.RBUF */
                    }
                }
            }
    ...
    OperationRegion (SMI0, SystemMemory, 0x7B6A6018, 0x1000)
